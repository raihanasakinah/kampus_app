...
import 'package:kampus_app/screen_page/page_detail.dart';
import 'package:kampus_app/screen_page/page_map_detail.dart'; // Import the MapsAllPage
...
class _KampusListState extends State<KampusList> {
  ...
  Future<ModelKampus> fetchKampus() async {
    final response = await http.get(Uri.parse('http://192.168.100.128/db_kampus_app/getKampus.php'));
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  image: DecorationImage(
                                    image: NetworkImage(
                                        'http://192.168.100.128/db_kampus_app/gambar/${kampus.gambarKampus}'),
                                    fit: BoxFit.cover,
                                  ),
                                ),
                              ),
